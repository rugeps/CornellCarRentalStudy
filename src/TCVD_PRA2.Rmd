...
ggplot(ds, aes(x=location.state, y=rate.daily, fill=location.state)) + geom_boxplot(alpha=0.1) + stat_summary(fun.y=mean)
```
...
**Model de regressió lineal mùltiple 1 (Preu ~ age + renterTripsTaken)**
